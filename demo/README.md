...
- `research/<thread>/context/` is generated packet/cache space. Packet YAML can be recreated with `chitking dispatch [--role <role>]` and is ignored by this demo's `.gitignore`.
