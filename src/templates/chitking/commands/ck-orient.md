...
3. Report maturity, readiness, warnings/blockers, stale generated packets, risky roles, and next safe actions from the command output.
...
- Do not change maturity/readiness, regenerate packets, record output, or edit source files unless the user explicitly asks.
